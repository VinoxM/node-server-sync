...
/**
 * 接收并分发处理 B站直播录制客户端 (Bilive-Live-Recorder) 的 Webhook 原始事件
 * @param {Object} body - Webhook 请求体
 * @param {string} body.EventType - 事件类型名称 (如 SessionStarted, FileClosed 等)
 * @param {string} body.EventTimestamp - 事件发生时间戳
 * @param {string} body.EventId - 事件唯一标识 UUID
 * @param {Record<string, any>} body.EventData - 事件详细参数载荷
