...
/**
 * 校验文件扩展名是否为动画视频格式
 * @param {string} ext - 文件扩展名 (如 `.mp4`, `.mkv`)
 * @returns {boolean}
 */
...
/**
 * 根据配置的正则表达式匹配提取文件名中的集数/话数
 * @param {string} file - 文件名
 * @returns {string|null} 集数字符串或 null
 */
 ...
 * @param {string|number} episode - 话数
 * @param {string} ext - 文件扩展名
 * @returns {string} 目标 MinIO 路径
 */
...
/**
 * 删除指定的异常剧集记录
 * @param {number} failedEpisodeId - 异常剧集 ID
 * @returns {Promise<ExecResult>}
 */
