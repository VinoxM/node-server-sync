import { dateFormatForDB, dateFormatFor30Hours } from '../../../common/utils/dateUtil.js';
...
export default {
    ...
    updateOne: (result) => {
        ...
        return __sqliteDB.update(sql, [result.title, result.torrent, result.pubDate, result.tracker, result.episode, dateFormatFor30Hours(result.pubDate), result.sort, result.id], enablePrint, dbName);
    },
    deleteOneById: (id) => {
