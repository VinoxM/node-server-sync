export const SSH_CMD_MINIO_MOVE_SCRIPT_U_QBIT = `sudo -u qbittorrent-nox -H bash -c '
set +H;
source_file="$1";
target_path="$2";
...
export const SSH_CMD_MINIO_COPY_SCRIPT_U_QBIT = `sudo -u qbittorrent-nox -H bash -c '
set +H;
source_file="$1";
target_path="$2";
