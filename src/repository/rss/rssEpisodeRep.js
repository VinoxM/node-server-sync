...
export default {
    ...
    selectExistsBySubsIdAndEpisode: (subsId, episode) => {
        ...
        return sqliteDB.selectOne(sql, [subsId, episode], null, dbName).then(data => data.count > 0)
    },
    ...
    selectFailedTaskExistsById: id => {
        ...
        return sqliteDB.selectOne(sql, [id], null, dbName).then(data => data.count > 0)
    }
}